...
function pokemons() {
    let pokemonEscolhido = escolhaDoTreinador(1)
    return pokemonEscolhido;
}

function escolhaDoTreinador(pokemons) {
    if (pokemons === 1) {
        return pokemons = "Voce escolheu o Bulbasaur como seu Pokemon inicial."
    } else if (pokemons === 2) {
        return pokemons = "Voce escolheu o Charmander como seu Pokemon inicial."
    } else if (pokemons === 4) {
        return pokemons = "Voce escolheu o Pikachu como seu Pokemon inicial."
    } else if (pokemons === 5) {
        
        return pokemons = "Voce escolheu o Mewtwoco como seu Pokemon inicial."
    }
}

function messageOut(pokemons, escolhaDoTreinador) {
    console.log(pokemons());
}
messageOut(pokemons, escolhaDoTreinador);